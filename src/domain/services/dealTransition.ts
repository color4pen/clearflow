...
const TERMINAL_PHASES: DealPhase[] = ["won", "lost", "passed"];

const ALL_PHASES: DealPhase[] = ["hearing", "proposal_prep", "proposed", "negotiation", "won", "lost", "passed"];

/**
 * 案件のフェーズ遷移が許可されているかを返す。
 * 終端状態（won, lost, passed）からの遷移は常に false。
