...
import { recordContractAdjustmentAction } from "@/app/actions/interactions";
import type { RecordContractAdjustmentState } from "@/app/actions/interactions";
...
const initialState: RecordContractAdjustmentState = {};

export function ContractInteractionSection({ contractId, interactions, canRecord }: Props) {
  ...
  return (
    <SectionCard className="p-3 mt-3">
      <h2 className="text-xs font-bold text-text mb-2">契約調整（やり取り）</h2>
