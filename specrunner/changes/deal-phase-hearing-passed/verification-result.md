# Verification Result — deal-phase-hearing-passed — iter 1
...
|---|-------|--------|----------|-----------|
| 1 | build | passed | 17.7s | 0 |
| 2 | typecheck | passed | 4.4s | 0 |
| 3 | test | passed | 1.1s | 0 |
...
✓ Generating static pages using 7 workers (41/41) in 165ms
...
[handleApprovalCompleted] originTriggerEntityId is null for requestId: req-1
 ...
 0 fail
 4673 expect() calls
Ran 1942 tests across 133 files. [1119.00ms]
