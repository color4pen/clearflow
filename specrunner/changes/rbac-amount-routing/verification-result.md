# Verification Result — rbac-amount-routing — iter 1
...
✓ Generating static pages using 7 workers (7/7) in 129ms
...
```
test-coverage: 30/30 must TCs covered
```
